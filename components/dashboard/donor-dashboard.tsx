...
import { Heart, Upload, User, FileText, CheckCircle, Clock, AlertCircle } from "lucide-react"
...
export function DonorDashboard({ user }: { user: any }) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 p-4">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Your journey of giving life starts here</p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-2">
                ...
                ) : "Create your donor profile to get started"}
              </p>
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {profile ? "Manage your donor information" : "Create your donor profile to start helping others"}
              </CardDescription>
            </CardHeader>
            <CardContent>
              {profile ? (
